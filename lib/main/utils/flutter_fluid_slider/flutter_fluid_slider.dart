...
class _FluidSliderState extends State<FluidSlider> with SingleTickerProviderStateMixin {
  ...
  TextStyle _currentValTextStyle(BuildContext context) {
    final TextStyle defaultStyle =
        widget.showDecimalValue ? Theme.of(context).textTheme.subtitle1!.copyWith(fontWeight: FontWeight.bold) : Theme.of(context).textTheme.headline6!.copyWith(fontWeight: FontWeight.bold);
