...
List<ProTheme> getDiamondKit() {
  ...
  list.add(ProTheme(name: 'SubScription 3', is_theme: true, type: '', widget: T14SubscriptionScreen3(), darkThemeSupported: true));
  list.add(ProTheme(name: 'SubScription 4', is_theme: true, type: '', widget: T14SubscriptionScreen4(), darkThemeSupported: true));
  list.add(ProTheme(name: 'SubScription 5', is_theme: true, type: '', widget: T14SubscriptionScreen5(), darkThemeSupported: true));
  list.add(ProTheme(name: 'SubScription 6', is_theme: true, type: '', widget: T14SubscriptionScreen6(), darkThemeSupported: true));
  list.add(ProTheme(name: 'SubScription 7', is_theme: true, type: '', widget: T14SubscriptionScreen7(), darkThemeSupported: true));
...
List<ProTheme> getMusicStreaming() {
  ...
  list.add(ProTheme(name: 'Profile', is_theme: true, type: '', widget: T11Profile()));
  list.add(ProTheme(name: 'Dashboard', is_theme: true, type: '', widget: T11Dashboard()));
  list.add(ProTheme(name: 'Search', is_theme: true, type: '', widget: T11Search()));
  list.add(ProTheme(name: 'Listing', is_theme: true, type: '', widget: T11List()));
  list.add(ProTheme(name: 'Description', is_theme: true, type: '', widget: T11Description()));
  list.add(ProTheme(name: 'Setting', is_theme: true, type: '', widget: T11Setting()));
  list.add(ProTheme(name: 'BottomSheet', is_theme: true, type: '', widget: T11BottomSheet()));
  return list;
}
...
List<ProTheme> getSignIn() {
  ...
  list.add(ProTheme(name: 'Sign In 10', is_theme: true, type: '', widget: T11SignIn(), darkThemeSupported: true));
...
List<ProTheme> getSignUp() {
  ...
  list.add(ProTheme(name: 'Sign Up 9', is_theme: true, type: '', widget: T11SignUp(), darkThemeSupported: true));
...
List<ProTheme> getDashboard() {
  ...
  list.add(ProTheme(name: 'Dashboard 10', is_theme: true, type: '', widget: T11Dashboard(), darkThemeSupported: true));
...
List<ProTheme> getDetailScreen() {
  ...
  list.add(ProTheme(name: 'Detail Screen 5', is_theme: true, type: '', widget: T11Description(), darkThemeSupported: true));
...
List<ProTheme> getBottomSheet() {
  ...
  list.add(ProTheme(name: 'Bottom Sheet 6', is_theme: true, type: '', widget: T11BottomSheet(), darkThemeSupported: true));
  return list;
}
...
List<ProTheme> getSearch() {
  ...
  list.add(ProTheme(name: 'Search 8', is_theme: true, type: '', widget: T11Search(), darkThemeSupported: true));
  return list;
}
...
List<ProTheme> getListing() {
  ...
  list.add(ProTheme(name: 'Listing 10', is_theme: true, type: '', widget: T11Dashboard(), darkThemeSupported: true));
...
List<ProTheme> getSettings() {
  ...
  list.add(ProTheme(name: 'Dialog 5', is_theme: true, type: '', widget: T11Setting(), darkThemeSupported: true));
  return list;
}
//endregion
...
ProTheme getFullApps() {
  ...
  list.add(ProTheme(name: 'Medium', type: 'New', widget: MSplashScreen()));
  list.add(ProTheme(name: 'Cloud Storage', type: 'New', widget: CSSplashScreen()));
  list.add(ProTheme(name: 'NewsBlog', type: '', widget: NBSplashScreen()));
  list.add(ProTheme(name: mpAppName, type: '', widget: MPSplashScreen()));
  list.add(ProTheme(name: 'Banking', type: '', widget: BankingSplash()));
  list.add(ProTheme(name: 'Pro Cricket', type: '', widget: PCSplashScreen()));
  list.add(ProTheme(name: 'Hair Salon', type: '', widget: BHSplashScreen()));
...
List<ProTheme> getIntegration() {
  ...
  list.add(ProTheme(name: 'File Picker', show_cover: false, type: '', widget: FilePickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Image Picker', show_cover: false, type: '', widget: ImagePickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Video Picker', show_cover: false, type: '', widget: VideoPickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Local Notification', show_cover: false, type: '', widget: LocalNotificationScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Fingerprint Authentication', show_cover: false, type: '', widget: FingerprintAuthentication(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Before After Image', show_cover: false, type: '', widget: BeforeAfterImageScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Google Sign In', show_cover: false, type: '', widget: GoogleSignInScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Wave Widget', show_cover: false, type: '', widget: WaveScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Signature Pad', show_cover: false, type: '', widget: SignatureScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Liquid Swipe WalkThrough', show_cover: false, type: '', widget: LiquidSwipeScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Calender', show_cover: false, type: '', widget: CalenderHomePage(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Confetti', show_cover: false, type: '', widget: CHomePage(), darkThemeSupported: true));
  list.add(ProTheme(name: 'TinderCard', show_cover: false, type: '', widget: TinderHomePage(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Show Case View', show_cover: false, type: '', widget: SVCHomePage(), darkThemeSupported: true));
...
List<ProTheme> getUI() {
  ...
  list.add(ProTheme(name: 'Custom Buttons', type: '', show_cover: false, widget: ButtonScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Pickers', type: '', show_cover: false, widget: PickerScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Slider', type: '', show_cover: false, widget: FluidSliderScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'ShaderMask', type: '', show_cover: false, widget: ShaderMaskScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Marquee', type: '', show_cover: false, widget: MHomePage(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Like Button', type: '', show_cover: false, widget: LBHomePage(), darkThemeSupported: true));
...
List<ProTheme> getLists() {
  ...
  list.add(ProTheme(name: 'Liquid Pull to Refresh', type: '', show_cover: false, widget: LiquidPullToRefreshScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Folding Cell in ListView', type: '', show_cover: false, widget: FoldingCellScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Shimmer', type: '', show_cover: false, widget: SHomePage(), darkThemeSupported: true));
...
List<ProTheme> getSubStickyHeader() {
  ...
  list.add(ProTheme(name: 'Header and Content', type: '', show_cover: false, widget: SimpleHeaders(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Animated Headers with Content', type: '', show_cover: false, widget: AnimatedHeaders(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Headers overlapping the Content', type: '', show_cover: false, widget: OverLappingHeaders(), darkThemeSupported: true));
...
List<ProTheme> getRestAPi() {
  ...
  list.add(ProTheme(name: 'Get example with FutureBuilder', type: '', show_cover: false, widget: GETMethodExampleScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Post example', type: '', show_cover: false, widget: PostMethodExampleScreen(), darkThemeSupported: true));
