...
class SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget loginWithGoogle = iconButton(
      context,
      keyString(context, "signup_with_google"),
      ic_google,
      () {},
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                text(
                  keyString(context, "register_desc"),
                  fontSize: ts_normal,
                ...
                Align(alignment: Alignment.center, child: text(keyString(context, "signup_with"), fontSize: ts_medium).paddingAll(spacing_standard_new)),
          ...
          Container(
            ...
            child: Align(
              ...
              child: Row(
                ...
                children: <Widget>[
                  text(keyString(context, "already_have_account"), fontSize: ts_medium, textColor: muvi_textColorPrimary).paddingAll(spacing_control),
                  text(keyString(context, "login"), fontSize: ts_medium, fontFamily: font_medium, textColor: muvi_colorPrimary).paddingAll(spacing_control).onTap(() {
                    finish(context);
                  })
                ],
              ).onTap(() {
