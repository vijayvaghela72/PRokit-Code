...
class MovieDetailScreenState extends State<MovieDetailScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    var moviePoster = AspectRatio(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          networkImage(
            "images/muvi/items/poster_1_ek9.png",
    ...
    var buttons = Row(
      ...
      children: <Widget>[
        Expanded(child: iconButton(context, keyString(context, "download"), ic_download, () {}, padding: 8.0).paddingRight(spacing_standard)),
        Expanded(
            child: iconButton(context, keyString(context, "my_list"), ic_add, () {},
                    padding: 8.0, backgroundColor: muvi_colorPrimary.withOpacity(0.1), buttonTextColor: muvi_colorPrimary, iconColor: muvi_colorPrimary)
                .paddingLeft(spacing_standard)),
      ],
